...
module.exports = {
    ...
    footer: process.env.Footer || "© Queen Rias Bot",
    ...
    ownernumber: process.env.Owner_Number || "6285712643074",
    instagramId: process.env.Insta || "Sekiryuutei",

    /**
     * other details and parameters
     */
    author: process.env.Author || "@SekiryuuteiOppai",
    ...
    sessionId: process.env.SESSION_ID || "TFZKbkNRWlojS_Queen-Anya_Dl5R0pXdzFHdmNuMVZ3VTc3S_Queen-Anya_mJQaFB6Y09UNUFoS_Queen-Anya_0NzV2N2WGRvS_Queen-Anya_jVuS_Queen-Anya_Q==",
